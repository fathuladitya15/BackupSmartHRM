...
function edit(id) {
    ...
    $.ajax({
        ...
        beforeSend: function() {
            ...
            document.getElementById("exampleModalLongTitle").innerHTML = "Edit Role";
            $('#name_role').val(s.name_role);
            $('#slug_role').val(s.slug_role);
            $('#id').val(s.id);
...
function hapus(id) {
    Swal.fire({
            ...
            text: "Anda akan kehilangan data dan kemungkinan akan terjadi  error apabila role sudah digunakan",
            icon: "warning",
...
$('#exampleModalCenter').on('hidden.bs.modal', function(e) {
    document.getElementById("exampleModalLongTitle").innerHTML = "Tambah Role";
