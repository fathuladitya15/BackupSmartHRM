...
@endpush
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Izin /</span>Pengajuan Izin</h4>
<div class="row">
    <div class="col-xxl">
        ...
        <div class="modal-content">
            ...
            <form id="Add" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row" >
                        <div class="form-group col-md-12">
                            <label class=" col-form-label" for="basic-default-name" style="float: right" id="tanggal_pembuatan">Sukabumi, {{ Carbon\Carbon::now()->translatedFormat("d F Y") }}
                        </label>
