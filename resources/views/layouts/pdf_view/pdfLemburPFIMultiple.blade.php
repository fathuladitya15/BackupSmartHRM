    ...
    <div class="container">
        ...
        <div class="row" style="text-align: center;">
            ...
            @php
                ...
                $id_manager    = App\Models\Filemanager::where('path',$dt->ttd_manager)->where("slug",'signature')->first()->id_karyawan;
                $nama_manager     = App\Models\User::where('id_karyawan',$id_manager)->first()->name;

                $id_direktur    = App\Models\Filemanager::where('path',$dt->ttd_direktur)->where("slug",'signature')->first()->id_karyawan;
                $nama_direktur    = App\Models\User::where('id_karyawan',$id_direktur)->first()->name;
        ...
        <div class="row" style="text-align: center;">
            ...
            <div class="col-lg-3">
                <img  src="{{ public_path($dt->ttd_manager) }}" alt="" style="width: 100px;"> <br />
                <div class="name_ttd" >{{ $nama_manager }}</div>
            </div>
            <div class="col-lg-3">
                <img  src="{{ public_path($dt->ttd_admin_korlap) }}" alt="" style="width: 100px;"> <br />
                <div class="name_ttd" >{{ $nama_admin }}</div>
            </div>
            <div class="col-lg-3">
                <img  src="{{public_path( $dt->ttd_direktur) }}" alt="" style="width: 100px;"> <br />
