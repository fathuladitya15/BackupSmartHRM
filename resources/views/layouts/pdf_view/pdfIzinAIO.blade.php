...
<body>
    <div class="container">
        <table width="100%">
            <tr>
                ...
                <td width="50" align="center">
                    ...
                    <h5> <u>IZIN (SAKIT,PULANG CEPAT/KEPERLUAN LAIN)</u></h5>
                </td>
                <td width="25">
                </td>
            </tr>
        ...
        <div class="row">
            ...
            <table width="100%" >
                ...
                <tr>
                    <td>Hari / Tanggal</td>
                    <td>:</td>
                    <td>{{ Carbon\Carbon::parse($data->tanggal_pembuatan)->translatedFormat('l') }}, {{ Carbon\Carbon::parse($data->tanggal_pembuatan)->translatedFormat("d F Y") }}. Jam Keluar {{ $data->jam_keluar }} WIB / Jam Masuk {{ $data->jam_masuk != null ? $data->jam_masuk." WIB" : '-' }}</td>
                </tr>
        ...
        <div class="row" style="text-align:center;">
            <div class="col-lg-4">
                <img class="gambar_tanda_tangan_kr" src="{{ public_path($data->ttd_mengetahui) }}" alt="" id="gambar_tanda_tangan_kr" width="100"> <br  />
                <div class="over_text">
            ...
            <div class="col-lg-4">
                <img class="gambar_tanda_tangan_admin" src="{{ public_path($data->ttd_karyawan)}}" alt="" id="gambar_tanda_tangan_admin" width="100"> <br  />
                <div class="over_text">
        ...
        <div class="row" id="footer">
            <div class="col-lg-12" style="font-size: 80%">
                Catatan : Untuk sakit atau yang lainnya diwajibkan memberikan informasi terlebih dahulu pada Koordinator sekertariat PT. PFI dan Leader
            </div>
        </div>
