        ...
        <div class="card mb-4">
            ...
            <div class="card-title">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" style="float: right">
                    <i class='bx bx-plus'></i> Tambah Peringatan
                </button>
            </div>
            <br>
            <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title black" id="exampleModalLongTitle">Tambah Peringatan</h5>
            ...
            <form id="Add" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id_sp" value="" id="id_sp">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <span class="text-danger pl-1">*</span>
                            <input class="form-control" required="required" placeholder="Nomor Surat" name="no_sp" type="text" value="" id="no_sp">
                        </div>
                    </div>
...
<script>
    ...
    var  url_data   = "{{ route('peringatan-data-admin') }}";
    var  url_detail = "{{ route('peringatan-detail') }}";
    var  url_update = "{{ route('peringatan-update') }}";
</script>
<script src="{{ asset('assets/js/admin_korlap/peringatan.js') }}"></script>
@endpush
