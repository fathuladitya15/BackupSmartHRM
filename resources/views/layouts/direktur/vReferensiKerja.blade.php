    ...
    <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title black" id="exampleModalLongTitle">Detail Referensi Kerja</h5>
            ...
            <form id="Add" enctype="multipart/form-data">
                ...
                <input type="hidden" name="status" value="4" id="status">
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-12" style="text-align:center;">
                            ...
                            <table class="table"  width="100%">
                                <tr>
                                    <td width="220" style="text-align: right; padding-right: 10px;">Nomor : </td>

                                    <td style="text-align: left; padding-left: 0px;" id="no_surat"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12" id="form-ttd">
